                            ...
                            switch (state.getCurrentUserLocationStatus) {
                              ...
                              case Status.success:
                                return ValueListenableBuilder(
                                  valueListenable:
                                      locationMapViewModel.newLocationNotifier,
                                        ...
                                        GetRoute(
                                          ...
                                          markerText:
                                              widget.params.showStoreFirst
                                                  ? appLocalizations.flowery
                                                  : appLocalizations.user,
                                          iconPath:
                                              widget.params.showStoreFirst
                                                  ? AssetsPaths.floweryStoreIcon
                                                  : AssetsPaths.userHomeIcon,
                                        ),
                                      );
                                      locationMapViewModel.getRouteCalledOnce =
                                          true;
                                    }
                                    switch (state
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          if (widget.params.showStoreFirst) ...[
                            ...
                            AddressItem(
                              title:
                                  widget.params.userEntity?.firstName == null &&
                                          widget.params.userEntity?.lastName ==
                                              null
                                      ? null
                                      : "${widget.params.userEntity?.firstName ?? ''} ${widget.params.userEntity?.lastName ?? ''}",
                              address: widget.params.storeEntity?.address,
                              phoneNumber: widget.params.userEntity?.phone,
                            ),
                          ] else ...[
                            /// User Address
                            Padding(
